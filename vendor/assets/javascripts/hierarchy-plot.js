function init_hierarchy_plot(element_id,data,count_function,color_function,title_function,legend_function)
{
    ...
    function process_data(data,level,start_deg,stop_deg)
    {
        ...
        data_slices.push({0:start_deg,1:stop_deg,2:name,3:level,4:data.amount,name:name,amount:data.amount});
