...
when "development"
  ...
  Transaction.create payee: "Wal-Mart", original_payee: '20397235 WALMART AS2385 SPRINGVILLE, UT', posted_at: Date.today - 5.days, amount: -25.64, envelope: groceries_envelope
  Transaction.create payee: "Target", original_payee: '20397235 TARGET AS2385 OREM, UT', posted_at: Date.today - 4.days, amount: -39.29, envelope: groceries_envelope
